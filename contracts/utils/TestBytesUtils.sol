...
contract TestBytesUtils {
    ...
    function test_keccak() public pure {
        ...
        require(
            "foo".keccak(0, 3)
                == bytes32(0x41b1a0649752af1b28b3dc29a1556eee781e4a4c3a1f7f53f90fa834de098c4d),
    ...
    function test_equals() public pure {
        ...
        require("hello".equals(1, "jello", 1, 4), "Substring to substring equality");
        require("zhello".equals(1, "abchello", 3), "Compare different value with multiple length");
        require(!"0x0102030000".equals(0, "0x010203"), "Compare with offset and trailing bytes");
    }

    function test_compare_partial() public pure {
        require("xax".compare(1, 1, "xxbxx", 2, 1) < 0, "Compare same length");
        require("xax".compare(1, 1, "xxabxx", 2, 2) < 0, "Compare different length");
        require("xax".compare(1, 1, "xxaxx", 2, 1) == 0, "Compare same with different offset");
        require(
            "01234567890123450123456789012345ab"
            .compare(0, 33, "01234567890123450123456789012345aa", 0, 33) == 0,
            "Compare different long strings same length smaller partial length which must be equal"
        );
        require(
            "01234567890123450123456789012345ab"
            .compare(0, 33, "01234567890123450123456789012345aa", 0, 34) < 0,
            "Compare long strings same length different partial length"
        );
        require(
            "0123456789012345012345678901234a"
            .compare(0, 32, "0123456789012345012345678901234b", 0, 32) < 0,
