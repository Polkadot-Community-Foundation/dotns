...
contract TestHexUtils {
    ...
    function addressToHex(address addr) external pure returns (string memory hexString) {
    ...
    function bytesToHex(bytes memory v) external pure returns (string memory hexString) {
